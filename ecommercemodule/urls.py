...
urlpatterns = [
    ...
    path("profile/address/<int:address_id>/edit/", views.address_edit, name="address_edit"),
    path("profile/address/<int:address_id>/delete/", views.address_delete, name="address_delete"),
    path("profile/address/<int:address_id>/set-default/", views.address_set_default, name="address_set_default"),
    ...
    path("products/<int:product_id>/reviews/save/", views.review_save, name="review_save"),
    path("products/<int:product_id>/reviews/delete/", views.review_delete, name="review_delete"),
    ...
    path("checkout/validate-voucher/", views.validate_voucher, name="validate_voucher_ajax"),
    path("checkout/buy-again/", views.buy_again_checkout, name="buy_again_checkout"),
